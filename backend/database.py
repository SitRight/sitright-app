...
from model import Todo, Predicts, User, UserInDB, TokenData, Token
...
async def fetch_all_predicts():
    predictions = []
    cursor = user_collection.find({})
    async for document in cursor:
        predictions.append(Predicts(**document))
    return predictions

async def create_predictions(predictions):
